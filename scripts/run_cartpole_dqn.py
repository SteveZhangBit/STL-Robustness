...
data3, _ = experiment3.run_diff_max_samples('Expc', np.arange(50, 151, 25), out_dir='data/cartpole-dqn/expc')
plt.figure()
evaluator3.heatmap(
    masses, forces, 25, 25,
    x_name="Masses", y_name="Forces", z_name="System Evaluation $\Gamma$",
...
plt.savefig('gifs/cartpole-dqn/robustness-expc.png', bbox_inches='tight')
...
boxplot([data1, data3], ['red', 'blue'], np.arange(50, 151, 25) * (1 + solver.options()['restarts']),
        ['CMA', 'CMA-Expc'])
plt.savefig('gifs/cartpole-dqn/sample-boxplot-expc.png', bbox_inches='tight')
