...
os.makedirs('old_gifs/lunar-lander-lqr', exist_ok=True)
...
data1 = experiment.run_diff_max_samples('CMA', samples, out_dir='old_data/lunar-lander-lqr/cma')
idx = np.argmin(data1['min_dist'])
plt.figure()
evaluator.heatmap(
    winds, turbulences, 25, 25,
    x_name="Wind", y_name="Turbulence", z_name="System Evaluation $\Gamma$",
    out_dir='old_data/lunar-lander-lqr',
...
plt.savefig('old_gifs/lunar-lander-lqr/fig-robustness.png', bbox_inches='tight')
# plt.show()
...
data2 = experiment2.run_diff_max_samples('Random', samples, out_dir='old_data/lunar-lander-lqr/random')
...
evaluator = Evaluator(prob, solver)
experiment = Experiment(evaluator)
data3 = experiment.run_diff_max_samples('STL2', samples, out_dir='old_data/lunar-lander-lqr/stl2')
idx = np.argmin(data3['min_dist'])
plt.figure()
evaluator.heatmap(
    winds, turbulences, 25, 25,
    x_name="Wind", y_name="Turbulence", z_name="System Evaluation $\Gamma$",
    out_dir='old_data/lunar-lander-lqr/stl2',
...
plt.savefig('old_gifs/lunar-lander-lqr/fig-robustness-stl2.png', bbox_inches='tight')
...
plt.savefig('old_gifs/lunar-lander-lqr/fig-boxplot.png', bbox_inches='tight')
# plt.show()
...
# # data3, _ = experiment3.run_diff_max_samples('Expc', np.arange(25, 126, 25), out_dir='old_data/lunar-lander-lqr/expc')
# plt.figure()
# evaluator3.heatmap(
#     winds, turbulences, 25, 25,
#     x_name="Wind", y_name="Turbulence", z_name="System Evaluation $\Gamma$",
#     out_dir='old_data/lunar-lander-lqr/expc',
#     # boundary=np.min(data3),
# )
# # plt.title('Robustness $\hat{\Delta}: ||\delta - \delta_0||_2 < %.3f$' % np.min(data3))
# plt.savefig('old_gifs/lunar-lander-lqr/fig-robustness-expc.png', bbox_inches='tight')
...
#         ['CMA', 'CMA-Expc'])
# plt.savefig('old_gifs/lunar-lander-lqr/sample-boxplot-expc.png', bbox_inches='tight')
