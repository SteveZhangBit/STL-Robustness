...
records_cma = experiment.record_min_violations(out_dir='data/ACC/traditional/cma_heuristic')
records_cma, violations_cma = experiment.summarize_violations(records_cma, 'data/ACC/traditional/cma_heuristic')
# Plot the samples
for i in range(len(records_cma)):
    ...
    plt.savefig(f'gifs/ACC/traditional/fig-violations-cma-heuristic-{i}.png', bbox_inches='tight')
...
plt.savefig(f'gifs/ACC/traditional/fig-violations-cma-heuristic-all.png', bbox_inches='tight')
