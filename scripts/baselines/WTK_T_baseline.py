...
for i in range(len(records_ol)):
    ...
    plt.savefig(f'gifs/WTK/traditional/fig-violations-ol-{i}.png', bbox_inches='tight')
...
plt.savefig(f'gifs/WTK/traditional/fig-violations-ol-all.png', bbox_inches='tight')
