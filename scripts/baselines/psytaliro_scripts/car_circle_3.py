...
def create_new_rob_csv(filename):
        ...
        with open('baseline_results/delta_car_circle_3.csv', mode='w', newline='') as file:
...
if __name__ == "__main__":
    filename = "baseline_results/car_circle_data_3.csv"
    if not os.path.isfile(filename):
        ...
        options = Options(runs=100, iterations=100, interval=(0, 1), static_parameters=[(5.0,35.0),(0.2,0.8),(5,50),(-3.0,3.0),(-3.0,3.0)])
