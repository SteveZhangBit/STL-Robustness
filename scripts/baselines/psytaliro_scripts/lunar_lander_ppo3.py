...
from robustness.envs.lunar_lander import DevLunarLander2, SafetyProp, SafetyProp2
...
def create_new_rob_csv(filename):
        ...
        with open('baseline_results/delta_lunarlander_3.csv', mode='w', newline='') as file:
...
if __name__ == "__main__":
    filename = "baseline_results/lunar_lander_data_3.csv"
    if not os.path.isfile(filename):
        ...
        options = Options(runs=100, iterations=100, interval=(0, 1), static_parameters=[(0.0,20.0),(0.0,2.0),(-12.0, 0.0),(-3.0,3.0),(-3.0,3.0)])
        result = staliro(lunarmodel, specification, optimizer, options)
        import csv 
        with open(filename, 'w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(['d1','d2','d3', 'i1', 'i2', 'Cost'])
