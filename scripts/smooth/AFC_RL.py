'''
The run script for the AFC example with the RL agent.
'''
...
radius = evaluator.smooth_boundary(0.1, 1000, 0.05, 0.9, 'data/AFC/RL')
# radius = 0.0
...
plt.savefig('gifs/AFC/RL/fig-smooth-robustness.png', bbox_inches='tight')
