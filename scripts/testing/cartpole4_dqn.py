...
records_cma = experiment.record_min_violations(out_dir='data/cartpole4-dqn/cma')
records_cma, violations_cma = experiment.summarize_violations(records_cma, 'data/cartpole4-dqn/cma')
...
records_random = experiment.record_min_violations(out_dir='data/cartpole4-dqn/random')
records_random, violations_random = experiment.summarize_violations(records_random, 'data/cartpole4-dqn/random')
