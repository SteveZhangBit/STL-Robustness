...
os.makedirs('gifs/ACC3/traditional', exist_ok=True)
...
records_cma = experiment.record_min_violations(out_dir='data/ACC3/traditional/cma')
records_cma, violations_cma = experiment.summarize_violations(records_cma, 'data/ACC3/traditional/cma')
...
records_random = experiment.record_min_violations(out_dir='data/ACC3/traditional/random')
records_random, violations_random = experiment.summarize_violations(records_random, 'data/ACC3/traditional/random')
