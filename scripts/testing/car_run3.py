...
os.makedirs('gifs/car-run3-ppo', exist_ok=True)
...
records_cma = experiment.record_min_violations(out_dir='data/car-run3-ppo/cma')
records_cma, violations_cma = experiment.summarize_violations(records_cma, 'data/car-run3-ppo/cma')
...
records_random = experiment.record_min_violations(out_dir='data/car-run3-ppo/random')
records_random, violations_random = experiment.summarize_violations(records_random, 'data/car-run3-ppo/random')
