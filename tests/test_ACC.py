...
os.makedirs('gifs/ACC', exist_ok=True)
...
sys_eval = BreachSystemEvaluator(eng, phi, {'restarts': 0, 'evals': 50})
solver = CMASolver(0.1, sys_eval, {'restarts': 0, 'evals': 50})
evaluator = Evaluator(prob, solver)

# print(solver.sys_evaluator.eval_sys(env.get_delta_0(), prob))

radius = evaluator.smooth_boundary(0.1, 100, 0.05, 0.9, 'data/ACC')
...
plt.savefig('gifs/ACC/fig-smooth-robustness.png', bbox_inches='tight')
