...
global dev_0;
global dev_bounds;
dev_names = {'MAF_sensor_tol', 'AF_sensor_tol'};
dev_0 = [MAF_sensor_tol; AF_sensor_tol];
dev_bounds = [MAF_sensor_tol_range; AF_sensor_tol_range];
pump_tol = 1;
kappa_tol = 1;
tau_ww_tol = 1;
fault_time = 50;
...
model.SetParamRanges('MAF_sensor_tol', MAF_sensor_tol_range);
model.SetParamRanges('AF_sensor_tol', AF_sensor_tol_range);
