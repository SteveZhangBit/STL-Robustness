...
EXP_NAME_KEYS = {"epochs": "epoch", "rs_mode": "mode"}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attacker', '-a', type=str, default='gaussian')
    ...
    if 'cvpo' in args.policy:
        args_dict["policy_name"] = "robust_cvpo"
        config_path = osp.join(CONFIG_DIR, "config_robust_cvpo.yaml")
        ...
        args_dict["policy_name"] = "sac_lag"
        config_path = osp.join(CONFIG_DIR, "config_sac_lag.yaml")
    elif "ppo" in args.policy:
